    ...
    async def stats(self, ctx, area, *, types):
        ...
        for stat in stat_list:
            if "mon" in stat:
                ...
                if "level" in stat:
                    if "1" in stat:
                        stats.append("raid_lvl1_active")
                    elif "2" in stat:
                        stats.append("raid_lvl2_active")
                    elif "3" in stat:
                        stats.append("raid_lvl3_active")
                    elif "4" in stat:
                        stats.append("raid_lvl4_active")
                    elif "5" in stat:
                        stats.append("raid_lvl5_active")
                    elif "all" in stat:
                        stats.append("raid_lvl5_active")
                        stats.append("raid_lvl4_active")
                        stats.append("raid_lvl3_active")
                ...
                if "level" in stat:
                    if "1" in stat:
                        stats.append("egg_lvl1_active")
                    elif "2" in stat:
                        stats.append("egg_lvl2_active")
                    elif "3" in stat:
                        stats.append("egg_lvl3_active")
                    elif "4" in stat:
                        stats.append("egg_lvl4_active")
                    elif "5" in stat:
                        stats.append("egg_lvl5_active")
                    elif "all" in stat:
                        stats.append("egg_lvl5_active")
                        stats.append("egg_lvl4_active")
                        stats.append("egg_lvl3_active")
