...
from dp.utils.util import Stop, Gym, Area, DPEmote, get_loading_footer, Mon, Item
...
class RaidBoard(Board):
    ...
    async def get_objs(self):
        raids = await self.bot.queries.execute("active_raids", sql_fence=self.area.sql_fence)
