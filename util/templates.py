...
class Templates():
    def __init__(self, bot, templates):
        ...
        self.quest_entry = "{emote} [{short_stop_name}]({map_link})"
        self.raid_board_entry = "{ex_emote} **{short_gym_name}**: Until {end}\n{boss_emote} **{boss_name}** - *{move_1} / {move_2}*\n"
        self.egg_board_entry = "{boss_emote} {ex_emote} **{short_gym_name}**: {start} – {end}"
        self.hundo_board_entry = "{mon_name}"
        #TODO templates
